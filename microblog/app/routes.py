...
<<<<<<< HEAD
from app.forms import RegistrationForm,LoginForm,PostForm,ResetPasswordRequestForm,ResetPasswordForm
...
def follow(username):
    ...
    if user == current_user:
        flash('You cannoy follow yourself!')
...
def unfollow(username):
    ...
    if user is None:
        ...
        return redirect(url_for('index'))
    if user == current_user:
        flash('You cannoy unfollow yourself!')
        return redirect(url_for('user',username=username))
